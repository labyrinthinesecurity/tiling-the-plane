...
def rotor(m0,m1,m2,m3,m4,m5,m6,m7):
  ...
  tile_image(f"xxx-{m0}{m1}{m2}{m3}{m4}{m5}{m6}{m7}",tiler(m0,m1,m2,m3,m4,m5,m6,m7))
...
#sequential_rotor()
montecarlo_rotor()
#rotor('C','T','U','U','N','J','K','W')
#rotor('B','B','J','T','T','B','V','B')
#sys.exit()
